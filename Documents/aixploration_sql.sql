...
--
-- Hôte : mysql-aixploration.alwaysdata.net
-- Généré le : dim. 15 jan. 2023 à 14:21
...
--
-- Base de données : `aixploration_sql`
--
...
CREATE TABLE `INDICE` (
  ...
  `CONTENUE` varchar(1000) DEFAULT NULL
...
INSERT INTO `INDICE` (`ID_INDICE`, `CONTENUE`) VALUES
...
CREATE TABLE `QUESTION` (
  ...
  `Parcour` varchar(1) DEFAULT NULL,
  `salle` varchar(100) DEFAULT NULL,
  `Enoncer` varchar(200) DEFAULT NULL,
...
INSERT INTO `QUESTION` (`ID_QUESTION`, `Parcour`, `salle`, `Enoncer`, `BonneReponse`, `Reponse1`, `Reponse2`, `Reponse3`, `Reponse4`) VALUES
...
(21, NULL, 'e1_r3', 'Qu\'est-ce qu\'une clé de cryptage?', 1, 'Un mot de passe utilisé pour crypter ou décrypter un message.', 'Un algorithme utilisé pour crypter ou décrypter un message.', 'Un fichier utilisé pour crypter ou décrypter un message.', ''),
...
(45, NULL, 'e2_r6', 'Qu\'est-ce que la virtualisation de conteneurs (Docker, Kubernetes) ?', 2, 'Une technique qui permet de stocker des données sur un support virtuel.\r\n', 'Une technique qui permet de virtualiser les applications pour les rendre plus flexibles et plus faciles à déployer.', 'Une technique qui permet de crypter les données.', 'Une technique qui permet de partager les ressources matérielles d\'un ordinateur ou d\'un réseau.');
