...
elseif ('/index.php/ajouteQuestion' == $uri) {
    $question = new Question(null,$_POST['Parcours'],$_POST['salle'],$_POST['Enonce'],$_POST['BonneReponse'],$_POST['Reponse1'],$_POST['Reponse2'],$_POST['Reponse3'],$_POST['Reponse4']);
...
elseif('/index.php/updateQuestion' == $uri){
    ...
    $data = (array)$data;
    $question = new Question($data['id'],$data['parcours'],$data['salle'],$data['enonce'],$data['bonneReponse'],$data['reponse1'],$data['reponse2'],$data['reponse3'],$data['reponse4']);
